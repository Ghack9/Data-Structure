...
con = sqlite3.Connection('Hotel Management Major Project.db')
cur = con.cursor()
cur.execute("create table if not exists hoteld(t_r number,r_r number,t_s number)")
cur.execute("create table if not exists roomd(rn number primary key, rstatus varchar (10) ,beds number,ac varchar(10),tv varchar(10),internet varchar(10),price number(10))")
...
Label(sroot,text="Made by - Gaurav Kumar",font='Timesnewroman 30 ',bg='white',fg='black').place(x=535,y=90)
Label(sroot,text="Roll Number : 1702111025",font='Timesnewroman 30',bg='white',fg='black').place(x=535,y=150)
Label(sroot,text='''   Under the Guidence of\n	  Mr. Dipankar Mishra Sir\n	   Head of Department\n	  ITES&M
      ''',font='Timesnewroman 30',bg='white',fg='black').place(x=535,y=270)
#----------- main project------------------------------------------------------------------------------------------------------------------
def mainroot():
	#sroot.destroy()
	root = Tk()
	...
	def staff():
		...
		Label(emp1inf,text="Gaurav",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		Label(emp1inf,text="Extention : 025",bg='white',fg="Grey",font='msserif 10').place(x=60,y=59)
		Label(emp1inf,text="Mail : gauravkumarjha27@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=60,y=83)
		...
		Label(emp1inf,text="Ms. Teena Rexwal",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		Label(emp1inf,text="Extention : 032",bg='white',fg="Grey",font='msserif 10').place(x=45,y=59)
		Label(emp1inf,text="Mail : rexwal@teena.com",bg='white',fg="Grey",font='msserif 10').place(x=45,y=83)	
		emp1inf.pack_propagate(False)
		...
		Label(emp1inf,text="Mr. G K Jha",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		Label(emp1inf,text="Extention : 028",bg='white',fg="Grey",font='msserif 10').place(x=72,y=59)
		Label(emp1inf,text="Mail : gk@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=72,y=83)	
		emp1inf.pack_propagate(False)
		...
		Label(emp1inf,text="Ms. TN Rexwal",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
		Label(emp1inf,text="Extention : 041",bg='white',fg="Grey",font='msserif 10').place(x=55,y=59)
		Label(emp1inf,text="Mail : tr@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=55,y=83)	
		emp1inf.pack_propagate(False)
	...
	#cur.execute("create table if not exists paymentsf(id number  primary key,f_name varchar,l_name varchar,c_number varchar,email varchar , r_n number ,day varchar,month varchar,year varchar,time varchar , method varchar)")
				...
				if temp == "Reserved":
					...
					rp = cur.fetchone()
					print (rp)
					amtpd = str(int(rp)*int(nod.get()))
					Label(payroot,text='Select an option to pay '+str(int(rp)*int(nod.get())),font='msserif 14 bold',bg='White').place(x=0,y=0)
		...
		nl = Label(b_frame,text='Made by Gaurav Kumar',fg='black',bg='gray91',font='msserif 8')
		nl.place(x=955,y=310)
		nl.tkraise()
	#-------------login module----------------------------------------------------------------------------------------------------------------------
	def login():
	...
	b5 = Button(sl_frame,image=img5,text='b2',bg='white',width=180,height=118,command=login)
	b5.image = img5
	b5.place(x=180*5,y=0)
	path6='images/bookroom.png'
	img6 = ImageTk.PhotoImage(Image.open(path6))
	b6 = Button(sl_frame,image=img6,text='b2',bg='white',width=180,height=118,command=reserve)
	b6.image = img6
